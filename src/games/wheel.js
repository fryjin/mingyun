...
const plugin={
  ...
  mount(root,ctx){
    ...
    root.innerHTML=`${stageHeader(plugin.title,`${count} 位玩家`)}<section class="game-stage centered casino-wheel-game"><div class="casino-felt"><div class="casino-wheel-assembly" data-assembly><span class="casino-top-marker" aria-hidden="true"></span><div class="casino-wood-rim"><div class="casino-gold-rim"><div class="casino-ball-track"><div class="casino-ball-orbit" data-ball-orbit><span class="casino-ball" data-ball></span></div><div class="casino-wheel-disc" data-wheel style="--step:${step}deg;--pockets:${pockets}">${labels}<span class="casino-inner-bowl"></span></div><div class="casino-spindle"><span>命</span></div></div></div></div></div><p class="casino-hint">小球落入的色格决定本轮玩家</p><button class="button primary large casino-spin-button" data-spin>转动轮盘</button></section>`;
    bindExit(root,ctx);
