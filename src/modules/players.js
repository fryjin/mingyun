...
export function renderPlayers(root){
  ...
  <section class="players-editor"><div class="section-title compact"><div><h2>玩家名称</h2><span>最多 4 个字符 · 可暂时离场</span></div></div><div class="player-list">${state.players.map(row).join('')}</div></section>
